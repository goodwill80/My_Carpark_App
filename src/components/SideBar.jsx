  ...
  return (
    <div className="sidebar sticky top-0 min-h-full z-[50] shadow-lg">
      ...
      <div
        ...
        } ease-in-out overflow-scroll duration-300 fixed top-0 z-[30] right-0 min-h-full h-[100vh] bg-gray-900 text-teal-50 text-md w-full sm:w-[390px] md:z-[50] space-y-6 p-8`}
      >
        {/* Logo */}
